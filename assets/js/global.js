const globals_pack = Object.freeze({
  ...
  CLUUFWEB_SERVER_FORM: `${globals_pack.CLUUFWEB_SERVER}/tour_app`,
  CLUUFWEB_SERVER_USER_FORM: `${globals_pack.CLUUFWEB_SERVER}/user_gym`,
  CLUUFWEB_SERVER_FORM_GYM: `${globals_pack.CLUUFWEB_SERVER}/subscription_app`,
});
...
const sendRequestGYMCluuf = (
  ...
  fetch(globals_pack.CLUUFWEB_SERVER_FORM_GYM, {
    method: "POST",
    headers: {
      "Content-Type": "application/x-www-form-urlencoded",
    },
